...
class JsonObjectViewerState extends State<JsonObjectViewer> {
  ...
  getValueWidget(MapEntry entry) {
    if (entry.value == null) {
      return Expanded(
          child: Text(
        'undefined', style: Theme.of(context).textTheme.subtitle2,
        // style: TextStyle(color: Colors.grey),
      ));
    ...
    return InkWell(
        child: GestureDetector(
            ...
            child: Text(
              'Object', style: Theme.of(context).textTheme.subtitle2,
              // style: TextStyle(color: Colors.grey),
            )),
        onTap: () {
          setState(() {
...
class _JsonArrayViewerState extends State<JsonArrayViewer> {
      ...
      list.add(Row(
        ...
        children: <Widget>[
          ...
          (ex && ink)
              ? getInkWell(i)
              : Text(
                  '[$i]', style: Theme.of(context).textTheme.subtitle2,
                  // style: TextStyle(
  ...
  getInkWell(int index) {
    return InkWell(
        child: Text(
          '[$index]', style: Theme.of(context).textTheme.subtitle2,
          // style: TextStyle(color: Colors.purple[900]),
        ),
        onTap: () {
          setState(() {
