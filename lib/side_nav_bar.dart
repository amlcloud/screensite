...
import 'package:screensite/controls/nav_rail.dart';
...
class CustomNavRail extends ConsumerWidget {
  ...
  final Map<String, NavigationRailDestination> destinations = {
    ...
    'search_centre': const NavigationRailDestination(
      icon: Icon(Icons.search),
      label: Text('Search Centre'),
    ),
    'alerts': const NavigationRailDestination(
    ...
    'sources': const NavigationRailDestination(
